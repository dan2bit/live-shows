...
Dashboard site (GitHub Pages): **[https://redhat-bootlegs.net/](https://redhat-bootlegs.net/)**
...
Includes an optional [d3 forceSimulation graph visualization](https://redhat-bootlegs.net/tools/research/graph/artist-graph.html) of related artists that appear in the attendance history and taste profile.
